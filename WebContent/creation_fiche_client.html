...
<body>
	...
	<form class="form-signin">
		...
		<div class="_58mq _5dbb" id="u_0_b">
			<div class="mtm mbs _58mr">Date de naissance</div>
			<br>
			<div class="_5k_5">
				<span class="_5k_4" data-type="selectors"
					data-name="birthday_wrapper" id="u_0_c"><span><select
						aria-label="Jour" name="birthday_day" id="day" title="Jour"
						class="_5dba"><option value="0" selected="1">Jour</option>
							...
							<option value="31">31</option></select><select aria-label="Mois"
						name="birthday_month" id="month" title="Mois" class="_5dba"><option
								value="0" selected="1">Mois</option>
							...
							<option value="12">déc</option></select><select aria-label="Ann&#xe9;e"
						name="birthday_year" id="year" title="Ann&#xe9;e" class="_5dba"><option
								value="0" selected="1">Année</option>
