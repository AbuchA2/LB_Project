...
@WebServlet(name = "Confirmation_inscription", urlPatterns = { "/confirmation_inscription" })

public class Confirmation_inscription extends HttpServlet {
     ...
     */
    public Confirmation_inscription() {
        super();
